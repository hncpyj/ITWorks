...
public class MemberVO implements java.io.Serializable {
	...
	public MemberVO(int corpNo, String rid, String jid, String did, String ename, String epwd, String phone, String email,
	...
	public String toString() {
		return "MemberVO [corpNo=" + corpNo + ", rid=" + rid + ", jid=" + jid + ", did=" + did + ", ename=" + ename
				...
				+ ", eid=" + eid + ", roleNo=" + roleNo + ", dname=" + dname + ", jname=" + jname + ", jNo=" + jNo + "]";
	}
