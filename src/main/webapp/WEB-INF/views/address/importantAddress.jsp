...
<body>
	...
	<%@ include file="./common/aside.jsp" %>
		...
		<div id="middleSection">
			...
			<form action="importDelete.ad" method="post">
			...
			<table id="addressTable">
				...
				<tr>
						<th class="${important.contactsNo }" style="width: 5%;">
						<input name="checkboxs" value="${important.contactsNo }" type="checkbox" id="checkAddress" onclick="showMe('deleteBtnArea')">
						</th>					
						<td class="${important.contactsNo }" style="width: 5%;" id="importantAdr">
					<c:choose>
						<c:when test="${ important.importCon eq 'N' }">
					...
					<td class="${important.contactsNo }" style="width: 10%;"><c:out value="${important.conName }"></c:out></td>
					<td class="${important.contactsNo }" style="width: 30%;"><c:out value="${important.email }"></c:out></td>
					<td class="${important.contactsNo }" style="width: 15%;"><c:out value="${important.conPhone }"></c:out></td>
					<td class="${important.contactsNo }" style="width: 10%;"><c:out value="${important.conCorp }"></c:out></td>
					<td class="${important.contactsNo }" style="width: 24%;"><c:out value="${important.tagName }"></c:out></td>
					<td class="${important.contactsNo }" style="width: 1%;"><input type="hidden" value="${important.contactsNo }"></td>
				</tr>
				</c:forEach>				
			</table>
			</form>
