...
<body>
    ...
    <section>
        <div id="fileBoxArea" align="center">
	        ...
	        <button class="folderEditBtn">수정</button>
	       <br>
            <form id="filebox">
		  ...
		  <br>
		  <button class="folderEditBtn">삭제</button>
	        <button class="folderEditBtn">새폴더</button>
        </div>
        <br>
    </section>
    <article>
        <div class="tableArea">
        	<div id="filePath">용량 100GB /500 GB</div>
		        <div id="fileSearch">
	        ...
	        <div id="fileOption">
	        	...
	        	<button class="fileOptionBtn">추가</button>
	        </div>
	     	<div id="RoleSetting">권한 설정</div>
	        <div>
	        	<div id="roleSelectArea">
				    ...
				    <div class="tree">
				      <div>
				        <input class="treebox" id="n-0" type="checkbox">
				        <label class="treelabel" for="n-0">경영지원팀</label>
				        <div class="sub">
				            <a href="#link">공지사항</a>
				            <div>
				              <input class="treebox" id="n-0-1" type="checkbox">
				      ...
				      <div>
				        <input class="treebox" id="n-1" type="checkbox">
				        <label class="treelabel" for="n-1">기술지원팀</label>
				        <div class="sub">
				          <a href="#link">규정</a>
				          <a href="#link">규칙</a>
				          <a href="#link">지침</a>
				      ...
				      <div>
				        <input class="treebox" id="n-2" type="checkbox">
				        <label class="treelabel" for="n-2">마케팅팀</label>
				        <div class="sub">
				          <a href="#link">기능1</a>
				          <a href="#link">기능2</a>
				        </div>
				      ...
				      <div>
				        <input class="treebox" id="n-3" type="checkbox">
				        <label class="treelabel" for="n-3">영업기획팀</label>
				        <div class="sub">
				            <a href="#link">공지사항</a>
				            <div>
				              <input class="treebox" id="n-3-1" type="checkbox">
				              <label class="treelabel" for="n-3-1">문서양식</label>
				              <div class="sub">
				                <a href="#link">인사관련</a>
				                <a href="#link">근태관련</a>
				                <a href="#link">일반기안</a>
		        ...
		        <div align="center" id="revoke">
		        	<h3>권한 부여</h3>
		        	<br>
		        	<input type="checkbox"> 조회<br>
		        	<input type="checkbox"> 수정<br>
		        	<input type="checkbox"> 삭제<br>
		        	<input type="checkbox"> 등록<br>
		        	<br>
		        	<button id="revokeBtnL">&gt</button><br>
		        	<button id="revokeBtnR">&lt</button>
		        	<br>
		        </div>
		        <div>
		       		<div id="roleInfo">
	        ...
	        <div id="fileOption">
	        	<button class="roleOptionBtn">추가</button>
	        	<button class="roleOptionBtn">취소</button>
	        </div>
		</div>
    </article>
