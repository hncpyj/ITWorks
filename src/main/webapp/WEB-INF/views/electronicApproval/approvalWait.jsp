...
<body>
	...
	<br>
 	<table style="margin:auto;">
		<tr>
			<td><p style="color:#004771; font-size:30px; width:660px;">결재대기함</p></td>
			<td width="90px">
				<select>
	...
	<table id="wait">
		<tr height="50px" style="background-color:#ffffff;">
			...
			<td width="330px">문서제목</td>
			<td width="50px">유형</td>
			<td width="150px">기안자</td>
			<td width="180px">기안부서</td>
			<td width="140px">기안일</td>
		</tr>
		<tr height="40px">
			<td width="170px">20200801-0001</td>
			<td width="330px">2020-07 예산서</td>
			<td width="50px">결재</td>
			<td width="150px">이호정</td>
			<td width="180px">영업기획팀</td>
			<td width="140px">2020/08/01</td>
		</tr>
		<tr height="40px">
			<td width="170px">20200801-0001</td>
			<td width="330px">2020-07 예산서</td>
