	...
	<c:if test="${ !empty loginUser }">
	    ...
	    <section>
	        ...
	        <article style="margin-top: 30px;">
	            <form action="searchAll.pm">
		            <div id="searchArea">
		                ...
		                <select name="progress" id="pprogress" style="width: 179px; height: 25px;">
	        ...
	        <article style="margin-top: 30px;">
				...
				<c:if test="${ pi.currentPage > 1 }">
					<c:url var="blistBack" value="/selectAllProjectList.pm">
				...
				<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
					...
					<c:if test="${ p ne pi.currentPage }">
						<c:url var="blistCheck" value="selectAllProjectList.pm">
				...
				<c:if test="${ pi.currentPage < pi.maxPage }">
					<c:url var="blistEnd" value="selectAllProjectList.pm">
						<c:param name="currentPage" value="${ pi.currentPage + 1 }"/>
					</c:url>
